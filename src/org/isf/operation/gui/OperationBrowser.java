	...
	public OperationBrowser() {
		...
		buttonNew.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent event) {
				operation = Context.getApplicationContext().getBean(
						Operation.class,
						null,
						"",
						Context.getApplicationContext().getBean(OperationType.class,"", ""),
						0); // operation will reference the new //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
																					// record
