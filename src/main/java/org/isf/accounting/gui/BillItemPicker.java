...
public class BillItemPicker extends javax.swing.JPanel {
	...
	private void initComponents(TableModel model) {
		...
		JLabel jLabelImage = new JLabel(MessageBundle.getMessage("angal.billitempicker.find.txt"));
		...
		JButton jButtonSelect = new javax.swing.JButton(MessageBundle.getMessage("angal.common.select.btn"));
		jButtonSelect.setMnemonic(MessageBundle.getMnemonic("angal.common.select.btn.key"));
		JButton jButtonQuit = new javax.swing.JButton(MessageBundle.getMessage("angal.common.cancel.btn"));
