...
public class MovStockBrowser extends ModalJFrame {
	...
	private MedicalStockMovementTypeBrowserManager medicalStockMovementTypeBrowserManager = Context.getApplicationContext()
					.getBean(MedicalStockMovementTypeBrowserManager.class);
	...
	private JComboBox getMovementTypeBox() {
		...
		try {
			type = medicalStockMovementTypeBrowserManager.getMedicaldsrstockmovType();
		} catch (OHServiceException e1) {
			type = null;
			OHServiceExceptionUtil.showMessages(e1);
		}
